...
<div class="main-content">
    ...
    <form action="${pageContext.request.contextPath}/admin-album" method="post" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-sm-12">
                <div class="form-group">
                    <div class="label">
                        Cover (Only PNG, JPG or JPEG images are allowed to be uploaded)
                    </div>
    ...
    <div class="row">
        <div class="col-6"></div>
        <div class="col-6">
            <a href="${pageContext.request.contextPath}/admin-album?do=list&id=${param.id}" class="btn btn-default light-text"><i class='bx bx-arrow-back'></i> Back to list</a>
        </div>
    </div>
</div>
<script>

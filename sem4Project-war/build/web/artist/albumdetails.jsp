    ...
    <div class="sm-container">
        <div class="zm-navbar">
            <ul class="zm-nav-info">
                ...
                <li class="zm-nav-info-item">
                    <a href="${pageContext.request.contextPath}/ClientArtist?do=info&id=${param.id}">Songs</a>
                </li>
                <li class="zm-nav-info-item">
        ...
        <div class="list">
            <div class="section-header">ALBUM</div>
            <div class="text">
                <div class="center">
            ...
            <div class="chart-music">
                <div class="section-header">TRACK IN ALBUM</div>
